...
def easy_portrait_classes():
    """Easy Portrait class names for external use."""
    return ['background', 'person', 'skin',
...
def easy_portrait_palette():
    """Easy Portrait palette for external use."""
    return [[0, 0, 0], [223, 87, 188], [160, 221, 255],
